...
public class EnemyLevel1 : MonoBehaviour
{
    ...
    void BuildBehaviorTree()
    {
        ...
        CheckIfPlayerIsNearEnemyLevel1Node checkIfPlayerIsNearEnemyLevel1Node = new CheckIfPlayerIsNearEnemyLevel1Node(this);
        ...
        sequenceNode1.add_kid(checkIfPlayerIsNearEnemyLevel1Node);
...
public class CheckIfPlayerIsNearEnemyLevel1Node : MyTaskNode
{
    EnemyLevel1 e = null;
    string typeOfEnemy = "";

    public CheckIfPlayerIsNearEnemyLevel1Node(EnemyLevel1 e)
    {
        this.e = e;
    }
